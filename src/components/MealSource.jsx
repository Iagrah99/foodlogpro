...
const MealSource = ({ value, onSave }) => {
  ...
  return (
    <td className="px-2 py-2 whitespace-nowrap text-center text-base font-medium text-gray-700 dark:text-gray-300">
      {isEditing ? (
        <input
          type="text"
          value={tempValue}
          ...
          className="px-2 py-1 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500"
          autoFocus
        />
      ) : (
        <span
