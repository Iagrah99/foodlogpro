        ...
        <>
          ...
          <div className="flex flex-col items-center px-0 sm:px-8 lg:px-16 text-gray-900 min-h-screen">
            <header className="text-center mb-12 min-h-screen min-w-full relative">
              ...
              <img
                src="https://i.ibb.co/fdcMKWc/bg-home.png"
                alt="Background"
              ...
              {/* Overlay and content */}
              <div className="min-h-screen flex flex-col justify-evenly items-center bg-black bg-opacity-75 p-8 md:p-12 relative z-10">
                <div>
            ...
            >
              ...
              <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
                ...
                >
                  <FontAwesomeIcon
                    icon={faUtensils}
                    className="text-5xl text-gray-100 mb-6"
                  />
                ...
                >
                  ...
                  <p className="text-lg text-gray-100">
                    Stay organised by planning your weekly dinners, making it
                    easier to eat balanced meals.
                  </p>
                </div>
                ...
                >
                  ...
                  <p className="text-lg text-gray-100">
                    Discover patterns in your eating habits, helping you make
                    healthier choices.
                  </p>
                </div>
              </div>
